...
const ProjectTable = () => {
  ...
  return (
    <div className="p-4 w-[93%] ml-[5rem]">
      ...
      <div className="flex items-center mb-5">
        <div className="relative">
          <button
            ...
            className="flex items-center justify-center p-2 text-white border border-gray-700 rounded"
          >
          ...
          {dropdownVisible && (
            <div className="absolute left-0 mt-2 bg-gray-800 border border-gray-700 rounded shadow-lg top-full">
              <button
        ...
        <div className="relative w-full ml-4">
          ...
          {filtersVisible && (
            <div className="absolute left-0 p-4 mt-2 bg-gray-800 border border-gray-700 rounded shadow-lg top-full">
              <div className="mb-2">
      ...
      {/* Main Table */}
      <table className="min-w-full text-white border border-gray-700 rounded table-auto">
        <thead>
          <tr>
              ...
              <td className="px-4 py-2">
                <div className="relative">
                  ...
                  {statusDropdownVisible === index && (
                    <div className="absolute right-0 mt-2 bg-gray-800 border border-gray-700 rounded shadow-lg top-full">
                      <button
      ...
      <div className="flex justify-end mt-4">
        <button
          ...
          className="px-4 py-2 mr-2 text-white bg-gray-700 rounded disabled:opacity-50"
        >
          Previous
        </button>
        ...
        <button
          ...
          onClick={() => handlePageChange(currentPage + 1)}
          className="px-4 py-2 ml-2 text-white bg-gray-700 rounded disabled:opacity-50"
        >
          Next
        </button>
      </div>
